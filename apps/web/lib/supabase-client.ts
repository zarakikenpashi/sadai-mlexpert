...
import { validatePublicSupabaseEnv, validateServerSupabaseEnv } from './supabase-config';
...
export function createServiceRoleSupabaseClient(env: Record<string, string | undefined> = process.env) {
