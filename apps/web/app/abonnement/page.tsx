const rows = [
  { label: 'Contexte', value: 'Formule Cabinet Pro' },
  { label: 'Statut', value: 'Actif' },
  { label: 'Signal', value: '24 entreprises / 15 utilisateurs' }
];
    ...
    <main className="page-wrap">
      <section className="page-hero">
        <div>
          ...
          <h1>Abonnement cabinet</h1>
          <p>Suivi manuel du statut SaaS, quotas et passage en lecture seule.</p>
        </div>
